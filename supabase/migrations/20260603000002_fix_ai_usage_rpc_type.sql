-- Fix try_increment_ai_usage: p_user_id was TEXT but ai_usage.user_id is UUID.
-- Implicit TEXT→UUID cast worked in practice, but explicit typing is correct
-- and avoids failures if non-UUID strings are ever passed.
